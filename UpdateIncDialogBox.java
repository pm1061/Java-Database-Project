...
public class UpdateIncDialogBox
{
    public static String [] display()
    {
        Stage window = new Stage();
        window.setTitle("Update Incident");
        ...
        gp.add(hb,1,9);
        gp.add(new Label("Leave field blank to remain unchanged\nFields marked with * are mandatory"),1,10);
        gp.add(Errorlb,1,11);
        ...
        OkBtn.setOnAction(e ->
        {
            ...
            {
                ex.printStackTrace();
                errorText += "Error: All ID fields must be an integer or left blank.\n";
                isInt = false;
            }

            if(vals[0].equals(""))
            {
                errorText += "Error: Incident ID is Mandatory\n";
                isInt = false;
            }
            ...
            if(vals[2].equals("low") || vals[2].equals("moderate")|| vals[2].equals("high") || vals[2].equals(""))
                isPri = true;
            else
            {
